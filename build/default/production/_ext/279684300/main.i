# 1 "D:/MP Lab/assignment_15.X/main.asm"
# 1 "<built-in>" 1
# 1 "D:/MP Lab/assignment_15.X/main.asm" 2
...
R_A equ 0 ; ((PORTB) and 07Fh), 0 is Row 1
R_B equ 1 ; ((PORTB) and 07Fh), 1 is Row 2
R_C equ 2 ; ((PORTB) and 07Fh), 2 is Row 3
R_D equ 3 ; ((PORTB) and 07Fh), 3 is Row 4
C_1 equ 4 ; ((PORTB) and 07Fh), 4 is Column 1
C_2 equ 5 ; ((PORTB) and 07Fh), 5 is Column 2
C_3 equ 6 ; ((PORTB) and 07Fh), 6 is Column 3
C_4 equ 7 ; ((PORTB) and 07Fh), 7 is Column 4
